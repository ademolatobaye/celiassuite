...
<head>
    ...
    <title>Restaurant | Celia's Suites</title>
    <meta name="description" content="Enjoy dining and refreshments at Celia's Suites with a welcoming restaurant experience for guests seeking comfort and great hospitality.">
    <meta name="keywords" content="Celia's Suites restaurant, restaurant in Abeokuta, hotel dining Abeokuta, bar and restaurant Ogun State, cuisine Abeokuta, hospitality dining Nigeria, food and drinks Abeokuta, guest dining Ogun State, event catering Abeokuta, lounge and restaurant Nigeria">
    <meta name="author" content="Ademola Omomeji, THEADEMOLA, THEADEMOLAOMOMEJI">
    <meta name="robots" content="index, follow">
    <meta name="theme-color" content="#aa8453">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://celiassuites.com/restaurant.php">
    <meta property="og:title" content="Restaurant | Celia's Suites">
    <meta property="og:description" content="Enjoy dining and refreshments at Celia's Suites with a welcoming restaurant experience for guests seeking comfort and great hospitality.">
    <meta property="og:image" content="https://celiassuites.com/icon.png">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://celiassuites.com/restaurant.php">
    <meta property="twitter:title" content="Restaurant | Celia's Suites">
    <meta property="twitter:description" content="Enjoy dining and refreshments at Celia's Suites with a welcoming restaurant experience for guests seeking comfort and great hospitality.">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link" href="rooms.html">Rooms & Suites </a></li>
                    <li class="nav-item"><a class="nav-link" href="restaurant.html">Restaurant</a></li>
                    <li class="nav-item"><a class="nav-link" href="gallery.html">Gallery</a></li>
                    <li class="nav-item"><a class="nav-link" href="contact.html">Contact</a></li>
                    <li class="nav-item"><a class="nav-link" href="#" id="theme-toggle">&#9790;</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="rooms-page section-padding" data-scroll-index="1">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <p class="mb-30">A relaxing rocky city makes the View a perfect spot to sip your favorite drink while watching the local serene environment in Abeokuta. This inviting lounge serves tasty snacks along with a variety of beers, wines, cocktails and spirits.</p>
                    <h6>Hours</h6>
                        ...
                        <div class="testimonials-box">
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="item"> <span class="quote"><img src="img/quot.png" alt=""></span>
                                    <p>Celia's Suites is situated in the â€œMother Cityâ€ of Abeokuta, Ogun state in Nigeria. Abeokuta lies in the wooded savannah, mixing historic architecture and modern conveniences.</p>
                                    <div class="info">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-column footer-about">
                            ...
                            <p class="footer-about-text">CELIA'S SUITES is an exclusive hotel in Abeokuta, where guests can enjoy affordable high end quality stay in a serene exclusive location home away from home.</p>

                            <div class="footer-language"> <i class="lni ti-world"></i>
                                <select onchange="location = this.value;">
                                    <option value="http://DCNL.com/">English</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="footer-column footer-contact">
                            ...
                            <p class="footer-contact-text">Abeokuta, Ogun State<br>Nigeria</p>
                            <div class="footer-contact-info">
                                <p class="footer-contact-phone"><span class="flaticon-call"></span> +234 809 991 3500</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-bottom-inner">
                            <p class="footer-bottom-copy-right">© Copyright 2026 by <a href="#">DCNL.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
